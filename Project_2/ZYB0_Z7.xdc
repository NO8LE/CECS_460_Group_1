## Clock Signal
set_property -dict { PACKAGE_PIN K17   IOSTANDARD LVCMOS33 } [get_ports {ACLK}]; # System Clock
#create_clock -period 10.000 [get_ports {ACLK}]  ; # 100 MHz => 10 ns
...
## Reset Button
set_property -dict { PACKAGE_PIN K19   IOSTANDARD LVCMOS33 } [get_ports {ARESETN}];
