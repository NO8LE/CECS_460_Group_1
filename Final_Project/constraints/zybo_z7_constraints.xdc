...
## Both addr and data_in are mapped to the same physical inputs since they're used in different states
## We connect them to data_in in the Verilog model
